...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 mt-4 sm:mt-6 px-3 overflow-y-auto">
      ...
      {/* Footer */}
      <div className="p-3 sm:p-4 border-t border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700">
